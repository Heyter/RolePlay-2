...
function EFFECT:Init(data)
	...
	local emitter = ParticleEmitter(pos)
		...
		for i=1, 250 do
			...
			particle:SetVelocity(Vector(math.random(-75,75),math.random(-75,75),math.random(-75,75)) * 5)
		...
		for i=1, 250 do
			...
			particle:SetVelocity(Vector(math.random(-75,75),math.random(-75,75),math.random(-75,10)) * 15)
