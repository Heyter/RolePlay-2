...
DIALOG["NPC_SecretHello"] = function( frame ) 
	local tbl = {
		{
			npcsay = "Guten Tag.\nWas kann ich für sie tun?",
			options = {
                ["Ich möchte der Secret-Service angehören."] = function( frame ) 
					CanDoJob( TEAM_SECRETSERVICE, function( canDo )
						if canDo then
							frame:GoToStage( 2 )
						else
							frame:Close()
...
DIALOG["NPC_SecretInTeam"] = function( frame ) 
	local tbl = {
		{
