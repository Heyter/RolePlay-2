...
DIALOG["NPC_RoadHello"] = function( frame ) 
	local tbl = {
		{
			npcsay = "Guten Tag.\nWas kann ich für sie tun?",
			options = {
                ["Ich möchte dem Abschleppdienst angehören."] = function( frame ) 
					CanDoJob( TEAM_ROAD, function( canDo )
						if canDo then
							frame:GoToStage( 2 )
						else
							frame:Close()
...
DIALOG["NPC_RoadInTeam"] = function( frame ) 
	local tbl = {
		{
        ...
        {
            npcsay = "Alles klar. Danke für deine Dienste.",
			options = {
