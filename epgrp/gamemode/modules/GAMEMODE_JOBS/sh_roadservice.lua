...
JOB.Name = "RoadService"                               // Wie der Job heißt
...
// Restrictions
JOB.RequiredGameMinutes = 30                   // Wie lange der Spieler gespielt haben muss, bevor er diesen Job ausführen kann
...
JOB.CarType = {}
JOB.CarType["scaniahtdm"] = "Bergungstruck für schwere Fahrzeuge"
