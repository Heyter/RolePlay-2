...
JOB.Name = "Citizen"                            // Wie der Job heißt
JOB.Description = "Bla Bla Bla"                 // Beschreibung vom Job
JOB.Model = {"models/player/kleiner.mdl"}       // Das/-Die Model/s vom Job
...
JOB.Lohn = 45                                   // Wie viel Lohn der angestellte bekommt
