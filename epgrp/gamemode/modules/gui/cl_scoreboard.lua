local function OpenContextMenu( tab )
	...
	if LocalPlayer():IsAdmin() then
		...
		job:AddSpacer()
		job:AddOption("Mayor", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(TEAM_MAYOR)) end)
		job:AddOption("Police", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(TEAM_POLICE)) end)
		job:AddOption("SWAT", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(TEAM_SWAT)) end)
		job:AddOption("Secret-Service", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(TEAM_SECRETSERVICE)) end)
		job:AddOption("Fireman", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(TEAM_FIRE)) end)
		job:AddOption("Medic", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(TEAM_MEDIC)) end)
		job:AddOption("Road-Service", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(TEAM_ROAD)) end)
