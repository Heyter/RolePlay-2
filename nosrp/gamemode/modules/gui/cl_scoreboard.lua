local function OpenContextMenu( tab )
	...
	if LocalPlayer():IsAdmin() then
		...
		job:AddSpacer()
		job:AddOption("Mayor", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(JOB_MAYOR)) end)
		job:AddOption("Police", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(JOB_POLICE)) end)
		job:AddOption("SWAT", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(JOB_SWAT)) end)
		job:AddOption("Secret-Service", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(JOB_SECRETSERVICE)) end)
		job:AddOption("Fireman", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(JOB_FIRE)) end)
		job:AddOption("Medic", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(JOB_MEDIC)) end)
		job:AddOption("Road-Service", function() RunConsoleCommand("rp_job",ply:SteamID(), tostring(JOB_ROAD)) end)
