...
function VC_HornOn(ent)
	...
	if ent.VC_AvIndicators then local DBL = ent.VC_AvIndicators.Horn if DBL and ent.VC_Indicators and !ent.VC_Indicators.Horn then VC_ApplyPoseParam(ent, DBL[1], DBL[3]) ent.VC_Indicators.Horn = table.Copy(DBL) end end
	ent.VC_HornOn = true ent:SetNWBool("VC_HornOn", ent.VC_HornOn)
	end
end
function VC_HornOff(ent)
	if ent.VC_HornOn then
	if ent.VC_Indicators and ent.VC_Indicators.Horn then VC_ApplyPoseParam(ent, ent.VC_Indicators.Horn[1], ent.VC_Indicators.Horn[2]) ent.VC_Indicators.Horn = nil end
