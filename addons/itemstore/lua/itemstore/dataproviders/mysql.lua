...
function PROVIDER:OnConnected()
	...
	self:Query( "CREATE TABLE IF NOT EXISTS Inventories( SteamID VARCHAR( 32 ) NOT NULL, Slot INT NOT NULL, Class VARCHAR( 255 ), Data BLOB, PRIMARY KEY ( SteamID, Slot ) )" )
	self:Query( "CREATE TABLE IF NOT EXISTS Banks( SteamID VARCHAR( 32 ) NOT NULL, Slot INT NOT NULL, Class VARCHAR( 255 ), Data BLOB, PRIMARY KEY ( SteamID, Slot ) )" )
end
