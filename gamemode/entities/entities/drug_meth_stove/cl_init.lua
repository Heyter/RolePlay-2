...
function ENT:Draw()
	...
	cam.Start3D2D(Pos + Ang:Right() * -15, TextAng, 0.1)
		draw.WordBox(2, -TextWidth*0.5 + 5, -30, "Drugs!", "RPNormal_25", Color(140, 0, 0, 100), Color(255,255,255,255))
		draw.WordBox(2, -TextWidth2*0.5 + 5, 18, "Price: $"..self.dt.price, "RPNormal_25", Color(140, 0, 0, 100), Color(255,255,255,255))
	cam.End3D2D()
end
